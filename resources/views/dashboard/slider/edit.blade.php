            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('slider.update', $slider->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ar_title" name="ar_title" rows="4" class="form-control ckeditor" placeholder="{{ trans('admin.slider') }} / {{ trans('admin.ar_title') }}..." value="{{ $slider->ar_title }}">
                    </div>
                    <div class="form-group">
                        <label for="en_title"> {{ trans('admin.slider') }} / {{ trans('admin.en_title') }}</label>
                        <input type="text" id="en_title" name="en_title" rows="4" class="form-control ckeditor" placeholder="{{ trans('admin.slider') }} / {{ trans('admin.en_title') }}..." value="{{ $slider->en_title }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="status">
                            <option value="1" {{ $slider->status == 1 ? 'selected' : '' }}> {{ __('admin.image') }} </option>
                            <option value="2" {{ $slider->status == 2 ? 'selected' : '' }}> {{ __('admin.video') }} </option>
                        </select>
                    </div>
