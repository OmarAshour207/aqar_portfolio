                ...
                <div class="flex">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ trans('admin.owners') }}</li>
                        </ol>
                    </nav>
                    <h1 class="m-0"> {{ trans('admin.owner') }} </h1>
                </div>
                <a href="{{ route('owners.create') }}" class="btn btn-success ml-3">{{ trans('admin.create') }} <i class="material-icons">add</i></a>
            </div>
        </div>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ substr($owner->ar_description, 0, 20) }}
                                    </div>
                                </div>
                            </td>
                            <td style="width: 120px;">
                                <div class="d-flex align-items-center">
                                    <div class="d-flex align-items-center">
                                        {{ substr($owner->en_description, 0, 20) }}
                                    </div>
                                </div>
                            </td>

                            <td style="width:120px" class="text-center">
                                <img src="{{ $owner->member_image }}" style="width: 120px; height: 50px">
                            </td>

                            <td>
                                <a href="{{ route('owners.edit', $owner->id) }}" class="btn btn-sm btn-link">
