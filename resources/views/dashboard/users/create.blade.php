            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('users.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input id="email" name="email" type="email" class="form-control" placeholder="{{ __('admin.email') }}" value="{{ old('email') }}">
                    </div>

                    <div class="form-group">
                        <label for="password"> {{ trans('admin.users') }} / {{ trans('home.password') }}</label>
                        <input id="password" name="password" type="password" class="form-control" placeholder="{{ __('home.password') }}" value="{{ old('password') }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="is_admin">
                            <option value="0" selected> {{ __('admin.user') }} </option>
                            <option value="1"> {{ __('admin.admin_role') }} </option>
                        </select>
                    </div>
