                            ...
                            <form class="form-contact" id="career-form" name="career-form" action="{{ route('send.contact') }}" method="POST">
                                ...
                                <label>
                                    ...
                                    <span class="form-group">
                                        <input type="text" class="form-control" id="name" name="name" placeholder="{{ __('home.full_name') }}*">
                                    </span>
                                </label>
                                <label>
                                ...
                                <label>
                                    ...
                                    <span class="form-group">
                                        <input type="text" class="form-control" id="number" name="number" placeholder="{{ __('home.phone') }}">
                                    </span>
                                </label>
                                <label class="mb-0">
        ...
        <div class="container">
            <div class="row counter-bg bottom-content">
                ...
                <div class="col-lg-4 col-md-12">
                    <a href="{{ url(setting('contact_us')) }}" class="btn text-white bottom-link mb-0">{{ __('home.contact_us') }}</a>
                </div>
            </div>
        </div>
    </section>
