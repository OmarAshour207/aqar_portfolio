(window.mr = window.mr || {}),
    (mr = (function (t, a, e, o) {
        ...
        function i(e) {
            (e = void 0 === e ? a : e),
                r.documentReady.concat(r.documentReadyDeferred).forEach(function (t) {
                    t(e);
                }),
                (t.status.documentReadyRan = !0),
                t.status.windowLoadPending && n(t.setContext());
        }
        function n(e) {
            t.status.documentReadyRan
                ? ((t.status.windowLoadPending = !1),
                  (e = "object" == typeof e ? a : e),
                  r.windowLoad.concat(r.windowLoadDeferred).forEach(function (t) {
                      t(e);
                  }))
                : (t.status.windowLoadPending = !0);
        }
        var r = { documentReady: [], documentReadyDeferred: [], windowLoad: [], windowLoadDeferred: [] };
        return (
    ...
    (mr = (function (t, r, a, e) {
        ...
        return (
            (t.util = {}),
            (t.util.requestAnimationFrame = a.requestAnimationFrame || a.mozRequestAnimationFrame || a.webkitRequestAnimationFrame || a.msRequestAnimationFrame),
            ...
            (t.util.sortChildrenByText = function (t, e) {
                ...
                void 0 !== e && (n = -(i = 1)),
                    ...
                    a.empty(),
                    r(o).each(function (t, e) {
                        a.append(e);
                    });
            }),
            (t.util.idleSrc = function (t, e) {
                (e = void 0 !== e ? e : ""),
                    (t.is(e + "[src]") ? t : t.find(e + "[src]")).each(function (t, e) {
            ...
            (t.util.activateIdleSrc = function (t, e) {
                (e = void 0 !== e ? e : ""),
                    (t.is(e + "[data-src]") ? t : t.find(e + "[data-src]")).each(function (t, e) {
    ...
    (mr = (function (i, t, n) {
        ...
        function a(t) {
            jQuery(n).off("scroll.mr"),
                jQuery(n).on("scroll.mr", function (t) {
                    !1 === i.scroll.busy &&
                        ((i.scroll.busy = !0),
                        e(function (t) {
                            i.scroll.update(t);
        ...
        return (
            ...
            (i.scroll.documentReady = a),
            i.components.documentReady.push(a),
            i
        );
    })(mr, jQuery, window, document)),
    (mr = (function (r, e, t) {
        "use strict";
        (r.scroll.classModifiers = {}),
            (r.scroll.classModifiers.rules = []),
            (r.scroll.classModifiers.parseScrollRules = function (n) {
                return (
                    n
            ...
            (r.scroll.classModifiers.update = function (t) {
                for (var e, a = r.scroll.y, o = r.scroll.classModifiers.rules, i = o.length; i--; )
                    a > (e = o[i]).scrollPoint && !e.hasClass && (e.element.classList.add(e.toggleClass), (e.hasClass = r.scroll.classModifiers.rules[i].hasClass = !0)),
                        a < e.scrollPoint && e.hasClass && (e.element.classList.remove(e.toggleClass), (e.hasClass = r.scroll.classModifiers.rules[i].hasClass = !1));
            });
        function a() {
        ...
        function o(e) {
            e("[data-scroll-class]").each(function () {
                ...
                a(),
                e(t).on("resize", a),
                r.scroll.classModifiers.rules.length && r.scroll.listeners.push(r.scroll.classModifiers.update);
        }
    ...
    (mr = (function (o, d, t, c) {
        "use strict";
        return (
            (o.accordions = o.accordions || {}),
            (o.accordions.documentReady = function (a) {
                a(".accordion__title").on("click", function () {
                    ...
                    "" !== t.location.hash && "#" !== t.location.hash && null === t.location.hash.match(/#\/.*/) && a(".accordion > li > .accordion__title" + t.location.hash).length && o.accordions.activatePanelById(t.location.hash, !0),
                    jQuery(c).on("click", 'a[href^="#"]:not(a[href="#"])', function () {
            ...
            (o.accordions.activatePanel = function (t, e) {
                ...
                if ((n.initEvent("panelOpened.accordions.mr", !0, !0), r.initEvent("panelClosed.accordions.mr", !0, !0), i.hasClass("active")))
                    !0 !== e && (i.removeClass("active"), a.trigger("panelClosed.accordions.mr").get(0).dispatchEvent(r));
            ...
            (o.accordions.activatePanelById = function (t, e) {
                ...
                "" === t ||
                    "#" === t ||
                    null !== t.match(/#\/.*/) ||
                    ((a = d(".accordion > li > .accordion__title#" + t.replace("#", ""))).length &&
                        (d("html, body")
                            .stop(!0)
                            .animate({ scrollTop: a.offset().top - 50 }, 1200),
                        o.accordions.activatePanel(a, e)));
            }),
            o.components.documentReady.push(o.accordions.documentReady),
            o
        );
    })(mr, jQuery, window, document)),
    (mr = (function (t) {
    ...
    (mr = (function (t) {
        ...
        return (
            ...
            (t.backgrounds.documentReady = function (e) {
    ...
    (mr = (function (t) {
        ...
        return (
            (t.bars = t.bars || {}),
            (t.bars.documentReady = function (a) {
    ...
    (mr = (function (r) {
        ...
        return (
            ...
            (r.countdown.options = r.countdown.options || {}),
            (r.countdown.documentReady = function (n) {
                n(".countdown[data-date]").each(function () {
                    ...
                    void 0 !== a.attr("data-date-fallback") && (e = a.attr("data-date-fallback") || "Timer Done"),
                        a.countdown(t, function (t) {
                            t.elapsed ? a.text(e) : a.text(t.strftime(i));
                        });
                });
            }),
            r.components.documentReadyDeferred.push(r.countdown.documentReady),
            r
        );
    })(mr, jQuery, window, document)),
    (mr = (function (t) {
    ...
    (mr = (function (e, t, r, o) {
        "use strict";
        return (
            (e.dropdowns = e.dropdowns || {}),
            (e.dropdowns.done = !1),
            (e.dropdowns.documentReady = function (a) {
                var t = !1;
                a('html[dir="rtl"]').length && (t = !0),
                    e.dropdowns.done ||
                        (jQuery(o).on("click", "body:not(.dropdowns--hover) .dropdown, body.dropdowns--hover .dropdown.dropdown--click", function (t) {
                            var e = jQuery(this);
                            jQuery(t.target).is(".dropdown--active > .dropdown__trigger")
                                ? (e.siblings().removeClass("dropdown--active").find(".dropdown").removeClass("dropdown--active"), e.toggleClass("dropdown--active"))
                                : (a(".dropdown--active").removeClass("dropdown--active"), e.addClass("dropdown--active"));
                        }),
            ...
            (e.dropdowns.repositionDropdowns = function (t) {
                t(".dropdown__container").each(function () {
                    ...
                    jQuery(this).css("left", ""),
                        ...
                        t.css("left", -e + a),
                        t.find('.dropdown__content:not([class*="lg-12"])').length && t.find(".dropdown__content").css("left", o - a);
                }),
            ...
            (e.dropdowns.repositionDropdownsRtl = function (t) {
                ...
                t(".dropdown__container").each(function () {
                    ...
                    jQuery(this).css("left", ""),
                        (t = jQuery(this)),
                        (e = n - (t.offset().left + t.outerWidth(!0))),
                        (a = jQuery(".containerMeasure").offset().left),
                        (o = n - (t.closest(".dropdown").offset().left + t.closest(".dropdown").outerWidth(!0))),
                        t.css("right", -e + a),
                        t.find('.dropdown__content:not([class*="lg-12"])').length && t.find(".dropdown__content").css("right", o - a);
                }),
                    t(".dropdown__content").each(function () {
                        var t, e, a, o, i;
            ...
            e.components.documentReady.push(e.dropdowns.documentReady),
            e
        );
    })(mr, jQuery, window, document)),
    (mr = (function (m, p, f, t) {
        ...
        return (
            (m.forms = m.forms || {}),
            (m.forms.captcha = {}),
            (m.forms.captcha.widgets = []),
            (m.forms.captcha.done = !1),
            (m.forms.documentReady = function (i) {
                (m.forms.captcha.widgets = []),
                    i('.input-checkbox input[type="checkbox"], .input-radio input[type="radio"]').each(function (t) {
                        var e = i(this),
                            a = e.siblings("label"),
                            o = "input-assigned-" + t;
                        void 0 === e.attr("id") || "" === e.attr("id") ? e.attr("id", o) : (o = e.attr("id")), a.attr("for", o);
                    }),
                    i(".input-number__controls > span")
                        .off("click.mr")
                    ...
                    i('form.form-email, form[action*="list-manage.com"], form[action*="createsend.com"]').attr("novalidate", !0).off("submit").on("submit", m.forms.submit),
                    i(t).on("change, input, paste, keyup", ".attempted-submit .field-error", function () {
                    ...
                    i('form[data-recaptcha-sitekey]:not([data-recaptcha-sitekey=""])').each(function () {
                        ...
                        (o = void 0 !== (o = n.attr("data-recaptcha-theme")) ? o : ""),
                            (i = void 0 !== (i = n.attr("data-recaptcha-size")) ? i : ""),
                            (m.forms.captcha.sitekey = n.attr("data-recaptcha-sitekey")),
                            r.length || ((t = n.find("button[type=submit]").closest('[class*="col-"]')), (r = jQuery("<div>").addClass("recaptcha")), jQuery("<div>").addClass("col-12").append(r).insertBefore(t)),
                            (e = { element: r.get(0), parentForm: n, theme: o, size: i }),
                            m.forms.captcha.widgets.push(e),
                            !1 === m.forms.captcha.done
                                ? jQuery('script[src*="recaptcha/api.js"]').length ||
                                  ((a = jQuery("<script async defer>")).attr("src", "https://www.google.com/recaptcha/api.js?onload=mrFormsCaptchaInit&render=explicit"), jQuery("body").append(a), (m.forms.captcha.done = !0))
                                : "undefined" != typeof grecaptcha && m.forms.captcha.renderWidgets();
                    });
            }),
            (m.forms.submit = function (t) {
                ...
                if (
                    (r.find(".form-error, .form-success").remove(),
                    c.attr("data-text", c.text()),
                    (a = s.attr("data-error") ? s.attr("data-error") : "Please fill all fields correctly"),
                    (n = s.attr("data-success") ? s.attr("data-success") : "Thanks, we'll be in touch shortly"),
                    r.append('<div class="form-error" style="display: none;">' + a + "</div>"),
                    r.append('<div class="form-success" style="display: none;">' + n + "</div>"),
                    (o = r.find(".form-error")),
                    (i = r.find(".form-success")),
                    s.addClass("attempted-submit"),
                            ...
                            p.ajax({
                                ...
                                success: function (t) {
                                    "success" !== t.result && 200 !== t.Status
                                        ? (o.attr("original-error", o.text()), o.html(t.msg).stop(!0).fadeIn(1e3), i.stop(!0).fadeOut(1e3), c.removeClass("btn--loading"))
                                        : (c.removeClass("btn--loading"), void 0 !== (e = s.attr("data-success-redirect")) && !1 !== e && "" !== e ? (f.location = e) : (m.forms.resetForm(s), m.forms.showFormSuccess(i, o, 1e3, 5e3, 500)));
                                },
                            });
                        } catch (t) {
                    ...
                    void 0 !== l && !1 !== l && o.text(l),
                        1 === m.forms.validateFields(s)
                            ? m.forms.showFormError(i, o, 1e3, 5e3, 500)
                            : (s.removeClass("attempted-submit"),
                              o.fadeOut(200),
                              c.addClass("btn--loading"),
                              jQuery.ajax({
                                  type: "POST",
                                  ...
                                  success: function (t) {
                                      c.removeClass("btn--loading"),
                                          p.isNumeric(t)
                                              ? 0 < parseInt(t, 10) &&
                                                (void 0 !== (e = s.attr("data-success-redirect")) && !1 !== e && "" !== e && (f.location = e),
                                                m.forms.resetForm(s),
                                                m.forms.showFormSuccess(i, o, 1e3, 5e3, 500),
                                                m.forms.captcha.resetWidgets())
                                              : (o.attr("original-error", o.text()), o.text(t).stop(!0).fadeIn(1e3), i.stop(!0).fadeOut(1e3));
                                  },
            ...
            (m.forms.validateFields = function (t) {
                var e,
                    ...
                    o = !1;
                if (
                    ((t = p(t)).find('.validate-required[type="checkbox"]').each(function () {
                        var t = p(this);
                    ...
                    t.find("div.recaptcha").length &&
                        ...
                        ((e = p(t.find("div.recaptcha"))), "" !== grecaptcha.getResponse(t.data("recaptchaWidgetID")) ? e.removeClass("field-error") : (e.addClass("field-error"), (o = 1))),
                    ...
                    i.length &&
                        p("html, body")
                            .stop(!0)
                            .animate({ scrollTop: i.offset().top - 100 }, 1200, function () {
                                i.focus();
                            });
            ...
            (m.forms.resetForm = function (t) {
                (t = p(t)).get(0).reset(),
                    ...
                    t
                        ...
                        .filter('[type="text"],[type="number"],[type="email"],[type="url"],[type="search"],[type="tel"]')
                        .each(function () {
                            var t = jQuery(this);
            ...
            (m.forms.captcha.renderWidgets = function () {
                m.forms.captcha.widgets.forEach(function (t) {
                    "" === t.element.innerHTML.replace(/[\s\xA0]+/g, "") &&
                        ((t.id = grecaptcha.render(t.element, { sitekey: m.forms.captcha.sitekey, theme: t.theme, size: t.size, callback: m.forms.captcha.setHuman })), t.parentForm.data("recaptchaWidgetID", t.id));
                });
            }),
            ...
            m.components.documentReadyDeferred.push(m.forms.documentReady),
            m
        );
    })(mr, jQuery, window, document)),
    (mr = (function (p) {
        ...
        return (
            (p.granim = p.granim || {}),
            (p.granim.documentReady = function (m) {
                m("[data-gradient-bg]").each(function (t, e) {
                    ...
                    if ((r.prepend('<canvas id="' + s + '"></canvas>'), !0 === /^(#[0-9|a-f|A-F]{6}){1}([ ]*,[ ]*#[0-9|a-f|A-F]{6})*$/.test(d))) {
                        ...
                        u.states = { "default-state": { gradients: c } };
                    }
                    (i = { element: "#" + s, name: "basic-gradient", direction: "left-right", opacity: [1, 1], isPausedWhenNotInView: !0, states: { "default-state": { gradients: c } } }),
                        (n = jQuery.extend({}, i, p.granim.options, u)),
                        m(this).data("gradientOptions", n),
                        m(this),
                        new Granim(n);
                });
            }),
            p.components.documentReadyDeferred.push(p.granim.documentReady),
            p
        );
    })(mr, jQuery, window, document)),
    (mr = (function (d) {
        ...
        return (
            ...
            (d.instagram.documentReady = function (e) {
                var a,
                    o,
                    i = {};
                if (e(".instafeed").length) {
                    var t,
                        n,
                        r = "4079540202.b9b1d8a.1d13c245c68d4a17bfbff87919aaeb14",
                        s = "b9b1d8ae049d4153b24a6332f0088686";
                    e(".instafeed[data-access-token][data-client-id]").length &&
                        ("" !== (t = e(".instafeed[data-access-token][data-client-id]").first().attr("data-access-token")) && (r = t),
                        "" !== (n = e(".instafeed[data-access-token][data-client-id]").first().attr("data-client-id")) && (s = n)),
                        (jQuery.fn.spectragram.accessData = { accessToken: r, clientID: s });
                }
                e(".instafeed").each(function () {
                    var t = e(this);
                    t.attr("data-user-name"),
                        (a = { query: "mediumrarethemes", max: 12 }),
                        (i.max = t.attr("data-amount")),
                        (i.query = t.attr("data-user-name")),
                        (o = jQuery.extend({}, a, d.instagram.options, i)),
                        t.append("<ul></ul>"),
                        t.children("ul").spectragram("getUserFeed", o);
                });
            }),
            d.components.documentReadyDeferred.push(d.instagram.documentReady),
            d
        );
    })(mr, jQuery, window, document)),
    (mr = (function (y, t, e, g) {
        ...
        return (
            (y.maps = y.maps || {}),
            (y.maps.options = y.maps.options || {}),
            (y.maps.documentReady = function (t) {
                t(".map-holder")
                    .on("click", function () {
                ...
                void 0 !== e.google &&
                    ...
                    jQuery(".gmaps-active").each(function () {
                        var a,
                            ...
                            h = {},
                            v = {};
                        (n = g.createEvent("Event")).initEvent("mapCreated.maps.mr", !0, !0),
                            (e = {
                                disableDefaultUI: !0,
                                draggable: d,
                                scrollwheel: !1,
                            ...
                            (h.styles = void 0 !== s.attr("data-map-style") ? JSON.parse(s.attr("data-map-style")) : void 0),
                            (h.zoom = s.attr("data-map-zoom") ? parseInt(s.attr("data-map-zoom"), 10) : void 0),
                            (h.zoomControlOptions = !1 !== c ? { position: google.maps.ControlPosition[c] } : void 0),
                            (t = { icon: { url: ("undefined" != typeof mr_variant ? "../" : "") + "img/mapmarker.png", scaledSize: new google.maps.Size(50, 50) }, title: "We Are Here", optimised: !1 }),
                            (v.icon = void 0 !== s.attr("data-marker-image") ? { url: s.attr("data-marker-image"), scaledSize: new google.maps.Size(50, 50) } : void 0),
                            (v.title = s.attr("data-marker-title")),
                            (o = jQuery.extend({}, e, y.maps.options.map, h)),
                            (i = jQuery.extend({}, t, y.maps.options.marker, v)),
                            void 0 !== f && "" !== f[0]
                                ? p.geocode({ address: f[0].replace("[nomarker]", "") }, function (t, e) {
                                      e === google.maps.GeocoderStatus.OK &&
                                          ((a = new google.maps.Map(r, o)),
                                          y.maps.instances.push(a),
                                          jQuery(r).trigger("mapCreated.maps.mr").get(0).dispatchEvent(n),
                                          a.setCenter(t[0].geometry.location),
                                          f.forEach(function (t) {
                                              if (/(\-?\d+(\.\d+)?),\s*(\-?\d+(\.\d+)?)/.test(t)) {
                                                  var e = t.split(",");
                                                  new google.maps.Marker(jQuery.extend({}, i, { position: { lat: 1 * e[0], lng: 1 * e[1] }, map: a }));
                                              } else
                                                  t.indexOf("[nomarker]") < 0 &&
                                                      new google.maps.Geocoder().geocode({ address: t.replace("[nomarker]", "") }, function (t, e) {
                                                          e === google.maps.GeocoderStatus.OK && new google.maps.Marker(jQuery.extend({}, i, { map: a, position: t[0].geometry.location }));
                                                      });
                                          }));
                                  })
                                : void 0 !== u &&
                                  ...
                                  "" !== m &&
                                  !1 !== m &&
                                  ((o.center = { lat: u, lng: m }),
                                  (a = new google.maps.Map(r, o)),
                                  new google.maps.Marker(jQuery.extend({}, i, { position: { lat: u, lng: m }, map: a })),
                                  y.maps.instances.push(a),
                                  jQuery(r).trigger("mapCreated.maps.mr").get(0).dispatchEvent(n));
                    }));
            }),
            y.components.documentReady.push(y.maps.documentReady),
            y
        );
    })(mr, jQuery, window, document)),
    (mr = (function (n, r, t, e) {
        ...
        return (
            (n.masonry = n.masonry || {}),
            (n.masonry.documentReady = function (o) {
                n.masonry.updateFilters(),
                    o(e).on("click touchstart", ".masonry__filters li:not(.js-no-action)", function () {
                        var t = o(this),
                            e = t.closest(".masonry").find(".masonry__container"),
                            a = "*";
                        "*" !== t.attr("data-masonry-filter") && (a = ".filter-" + t.attr("data-masonry-filter")),
                            t.siblings("li").removeClass("active"),
                            t.addClass("active"),
                            e.removeClass("masonry--animate"),
                            e.on("layoutComplete", function () {
                                o(this).addClass("masonry--active"),
            ...
            (n.masonry.windowLoad = function () {
                r(".masonry").each(function () {
                    var t,
                        e = r(this).find(".masonry__container"),
                        a = r(this),
                        o = "*",
                        i = {};
                    (t = { itemSelector: ".masonry__item", filter: "*", masonry: { columnWidth: ".masonry__item" } }),
                        a.is("[data-default-filter]") &&
                            ((o = ".filter-" + (o = a.attr("data-default-filter").toLowerCase())),
                            a.find("li[data-masonry-filter]").removeClass("active"),
                            a.find('li[data-masonry-filter="' + a.attr("data-default-filter").toLowerCase() + '"]').addClass("active")),
                        (i.filter = "*" !== o ? o : void 0),
                        e.on("layoutComplete", function () {
                            e.addClass("masonry--active"),
                                "undefined" != typeof mr_parallax &&
                                    setTimeout(function () {
                                        mr_parallax.profileParallaxElements();
                                    }, 100);
            ...
            (n.masonry.updateFilters = function (t) {
                r((t = void 0 !== t ? t : ".masonry")).each(function () {
                    ...
                    a.is(".masonry") &&
                        t.find(".masonry__item[data-masonry-filter]").length &&
                        ((i = e.find("> ul")).length || (i = e.append("<ul></ul>").find("> ul")),
                        t.find(".masonry__item[data-masonry-filter]").each(function () {
                            var o = r(this),
                                t = o.attr("data-masonry-filter"),
                                e = [];
                            void 0 !== t && "" !== t && (e = t.split(",")),
                        ...
                        n.util.sortChildrenByText(r(this).find(".masonry__filters ul")),
            ...
            n.components.documentReady.push(n.masonry.documentReady),
            n.components.windowLoad.push(n.masonry.windowLoad),
            n
        );
    })(mr, jQuery, window, document)),
    (mr = (function (n, o, r, s) {
        ...
        return (
            (n.modals = n.modals || {}),
            (n.modals.documentReady = function (i) {
                var t = '<div class="all-page-modals"></div>',
                    e = i("div.main-container");
                if (
                    (e.length ? (jQuery(t).insertAfter(e), (n.modals.allModalsContainer = i("div.all-page-modals"))) : (jQuery("body").append(t), (n.modals.allModalsContainer = jQuery("body div.all-page-modals"))),
                    i(".modal-container").each(function () {
                        var t = i(this),
                    ...
                    i(".modal-trigger").on("click", function () {
                        ...
                        return (
                            (e =
                                void 0 !== a.attr("data-modal-id")
                                    ? ((t = a.attr("data-modal-id")), n.modals.allModalsContainer.find('.modal-container[data-modal-id="' + t + '"]'))
                                    : ((t = i(this).attr("data-modal-index")), n.modals.allModalsContainer.find('.modal-container[data-modal-index="' + t + '"]'))),
                            n.util.activateIdleSrc(e, "iframe"),
                            n.modals.autoplayVideo(e),
                            n.modals.showModal(e),
                            !1
                        );
                    }),
                    jQuery(s).on("click", ".modal-close", n.modals.closeActiveModal),
                    jQuery(s).keyup(function (t) {
                    ...
                    i(".modal-container[data-show-on-exit]").each(function () {
                        var t = jQuery(this),
                            ...
                            a = 0;
                        t.attr("data-delay") && (a = parseInt(t.attr("data-delay"), 10) || 0),
                            i(e).length &&
                                (t.prepend(i('<i class="ti-close close-modal">')),
                                jQuery(s).on("mouseleave", e, function () {
            ...
            (n.modals.closeActiveModal = function () {
                ...
                n.util.idleSrc(t, "iframe"),
                    n.util.pauseVideo(t),
                    void 0 !== t.attr("data-cookie") && n.cookies.setItem(t.attr("data-cookie"), "true", 1 / 0, "/"),
                    t.length &&
                        (t.is("[data-modal-id]") && r.location.hash === "#" + t.attr("data-modal-id") && n.util.removeHash(),
                        e.initEvent("modalClosed.modals.mr", !0, !0),
                        t.removeClass("modal-active").trigger("modalClosed.modals.mr").get(0).dispatchEvent(e));
            }),
            (n.modals.autoplayVideo = function (t) {
                t.find("video[autoplay]").length && t.find("video").get(0).play();
            }),
            n.components.documentReady.push(n.modals.documentReady),
            n
        );
    })(mr, jQuery, window, document)),
    (mr = (function (s, a) {
        "use strict";
        return (
            (s.newsletters = s.newsletters || {}),
            (s.newsletters.documentReady = function (a) {
                var e, t, o, i, n, r;
                a('form[action*="createsend.com"]').each(function () {
                    (e = a(this)).attr("novalidate", "novalidate"),
                        e.is(".form--no-placeholders")
                            ? e.find("input[placeholder]").removeAttr("placeholder")
                            : e.find("input:not([checkbox]):not([radio])").each(function () {
                                  var t = a(this);
                                  void 0 !== t.attr("placeholder")
                                      ? "" === t.attr("placeholder") && t.siblings("label").length && (t.attr("placeholder", t.siblings("label").first().text()), e.is(".form--no-labels") && t.siblings("label").first().remove())
                                      : t.siblings("label").length && (t.attr("placeholder", t.siblings("label").first().text()), e.is(".form--no-labels") && t.siblings("label").first().remove()),
                        ...
                        e.find('input[type="checkbox"]').each(function () {
                            (t = a(this)),
                                (i = t.attr("id")),
                                (o = e.find("label[for=" + i + "]")).length || (o = a('<label for="' + i + '"></label>')),
                                t.before('<div class="input-checkbox" data-id="' + i + '"></div>'),
                                a('.input-checkbox[data-id="' + i + '"]').prepend(t),
                                a('.input-checkbox[data-id="' + i + '"]').prepend(o);
                        }),
                        e.find('button[type="submit"]').each(function () {
                            var t = a(this);
                            t.addClass("btn"), t.parent().is("p") && t.unwrap();
                        }),
                        e.find("[required]").attr("required", "required").addClass("validate-required"),
                    ...
                    a('form[action*="list-manage.com"]').each(function () {
                        (e = a(this)).attr("novalidate", "novalidate"),
                            ...
                            e.find('input[type="checkbox"]').each(function () {
                                (t = jQuery(this)),
                                    (n = t.parent()),
                                    (o = n.find("label")).length || (o = jQuery("<label>")),
                                    t.before('<div class="input-checkbox"></div>'),
                                    n.find(".input-checkbox").append(t),
                                    n.find(".input-checkbox").append(o);
                            }),
                            e.find('input[type="radio"]').each(function () {
                                (r = jQuery(this)),
                                    (n = r.closest("li")),
                                    (o = n.find("label")).length || (o = jQuery("<label>")),
                                    r.before('<div class="input-radio"></div>'),
                                    n.find(".input-radio").prepend(r),
                                    n.find(".input-radio").prepend(o);
                            }),
                            ...
                            e.find("#mce-responses").remove(),
                            e.find(".mc-field-group").each(function () {
            ...
            s.components.documentReady.push(s.newsletters.documentReady),
            s
        );
    })(mr, jQuery, window, document)),
    (mr = (function (r, o, t, s) {
        ...
        return (
            ...
            (r.notifications.documentReady = function (a) {
            ...
            (r.notifications.showNotification = function (t, e) {
                ...
                if (
                    (setTimeout(function () {
                        i.initEvent("notificationOpened.notifications.mr", !0, !0),
                            a.addClass("notification--reveal").trigger("notificationOpened.notifications.mr").get(0).dispatchEvent(i),
                            a.closest("nav").addClass("notification--reveal"),
                            a.find("input").length && a.find("input").first().focus();
                    }, o),
                    t.is("[data-autohide]"))
                ) {
            ...
            (r.notifications.closeNotification = function (t) {
                ...
                (t = e.is(".notification") ? e : e.is(".notification-close") ? e.closest(".notification") : o('.notification[data-notification-link="' + t + '"]')),
                    a.initEvent("notificationClosed.notifications.mr", !0, !0),
                    t.addClass("notification--dismissed").trigger("notificationClosed.notifications.mr").get(0).dispatchEvent(a),
                    t.closest("nav").removeClass("notification--reveal"),
                    void 0 !== t.attr("data-cookie") && r.cookies.setItem(t.attr("data-cookie"), "true", 1 / 0, "/");
            }),
            r.components.documentReady.push(r.notifications.documentReady),
            r
        );
    })(mr, jQuery, window, document)),
    (mr = (function (t, e, s) {
            ...
            (t.progressHorizontal.documentReady = function (t) {
                ...
                t(".progress-horizontal").each(function () {
                    ...
                    t.prepend(a),
                        (e.element = t),
                        (e.progress = a),
                        (e.value = parseInt(t.attr("data-value"), 10) + "%"),
                        (e.offsetTop = t.offset().top),
                        (e.animate = !1),
                        jQuery(this).hasClass("progress-horizontal--animate") ? (e.animate = !0) : a.css("width", e.value),
                        o.push(e);
                });
            }),
    ...
    (mr = (function (n) {
        "use strict";
        return (
            (n.easypiecharts = n.easypiecharts || {}),
            (n.easypiecharts.pies = []),
            (n.easypiecharts.options = n.easypiecharts.options || {}),
            (n.easypiecharts.documentReady = function (t) {
                t(".radial").each(function () {
                    var t,
                        ...
                        o = 110,
                        i = {};
                    (e = { animate: { duration: 2e3, enabled: !0 }, barColor: "#000000", scaleColor: !1, size: o, lineWidth: 3 }),
                        void 0 !== n.easypiecharts.options.size && (o = n.easypiecharts.options.size),
                        void 0 !== a.attr("data-timing") && (i.animate = { duration: parseInt(a.attr("data-timing"), 10), enabled: !0 }),
                        void 0 !== a.attr("data-color") && (i.barColor = a.attr("data-color")),
                        void 0 !== a.attr("data-size") && (o = i.size = parseInt(a.attr("data-size"), 10)),
                        void 0 !== a.attr("data-bar-width") && (i.lineWidth = parseInt(a.attr("data-bar-width"), 10)),
                        a.css("height", o).css("width", o),
                        "object" == typeof n.easypiecharts.options && (t = jQuery.extend({}, e, n.easypiecharts.options, i)),
                        a.easyPieChart(t),
            ...
            (n.easypiecharts.activate = function () {
                n.easypiecharts.pies.forEach(function (t) {
                    Math.round(n.scroll.y + n.window.height) >= Math.round(t.top + t.height) &&
                        !1 === t.active &&
                        (t.element.data("easyPieChart").enableAnimation(), t.element.data("easyPieChart").update(t.value), t.element.addClass("radial--active"), (t.active = !0));
                });
            }),
            n.components.documentReadyDeferred.push(n.easypiecharts.documentReady),
            n
        );
    })(mr, jQuery, window, document)),
    (mr = (function (s) {
        ...
        return (
            (s.sliders = s.sliders || {}),
            (s.sliders.documentReady = function (r) {
                r(".slider").each(function (t) {
                    ...
                    var o = e.find("li").length,
                        ...
                        n = {};
                    (n.pageDots = ("true" === a.attr("data-paging") && 1 < e.find("li").length) || void 0),
                        (n.prevNextButtons = "true" === a.attr("data-arrows") || void 0),
                        (n.draggable = "false" !== a.attr("data-draggable") && void 0),
                        (n.autoPlay = "false" !== a.attr("data-autoplay") && (a.attr("data-timing") ? parseInt(a.attr("data-timing"), 10) : void 0)),
                        (n.accessibility = "false" !== a.attr("data-accessibility") && void 0),
                        (n.rightToLeft = "true" === a.attr("data-rtl") || void 0),
                        (n.initialIndex = a.attr("data-initial") ? parseInt(a.attr("data-initial"), 10) : void 0),
                        (n.freeScroll = "true" === a.attr("data-freescroll") || void 0),
                        a.attr("data-children", o),
                        r(this).data("sliderOptions", jQuery.extend({}, i, s.sliders.options, n)),
                        r(e).flickity(r(this).data("sliderOptions")),
                        r(e).on("scroll.flickity", function (t, e) {
            ...
            s.components.documentReadyDeferred.push(s.sliders.documentReady),
            s
        );
    })(mr, jQuery, window, document)),
    (mr = (function (n, o, r) {
        "use strict";
        return (
            (n.smoothscroll = n.smoothscroll || {}),
            (n.smoothscroll.sections = []),
            (n.smoothscroll.init = function () {
                (n.smoothscroll.sections = []),
                    o("a.inner-link").each(function () {
                        var t = {},
                            e = o(this),
                            a = e.attr("href");
                        new RegExp("^#[^\r\n\t\f\v#.]+$", "gm").test(a) &&
                            o("section" + a).length &&
                            ((t.id = a), (t.top = Math.round(o(a).offset().top)), (t.height = Math.round(o(a).outerHeight())), (t.link = e.get(0)), (t.active = !1), n.smoothscroll.sections.push(t));
                    }),
            ...
            n.scroll.listeners.push(n.smoothscroll.highlight),
            (n.smoothscroll.documentReady = function (a) {
                var t,
                    e,
                    o = a("a.inner-link"),
                    i = {};
                (e = { selector: ".inner-link", selectorHeader: null, speed: 750, easing: "easeInOutCubic", offset: 0 }),
                    o.length &&
                        (o.each(function (t) {
                            var e = a(this);
                        ...
                        n.smoothscroll.init(),
                        a(r).on("resize", n.smoothscroll.init),
                        (t = 0),
                        a("body[data-smooth-scroll-offset]").length && ((t = a("body").attr("data-smooth-scroll-offset")), (t *= 1)),
                        (i.offset = 0 !== t ? t : void 0),
                        smoothScroll.init(jQuery.extend({}, e, n.smoothscroll.options, i)));
            }),
            n.components.documentReady.push(n.smoothscroll.documentReady),
            n.components.windowLoad.push(n.smoothscroll.init),
            n
        );
    })(mr, jQuery, window, document)),
    (mr = (function (a, s, t, d) {
        ...
        return (
            (a.tabs = a.tabs || {}),
            (a.tabs.documentReady = function (o) {
                o(".tabs").each(function () {
                    ...
                    "" !== t.location.hash && a.tabs.activateTabById(t.location.hash),
            ...
            (a.tabs.activateTab = function (t) {
                ...
                r.initEvent("tabOpened.tabs.mr", !0, !0),
                    o.find("> .tabs > li").removeClass("active"),
                    o.find("> .tabs-content > li").removeClass("active"),
                    a.addClass("active").trigger("tabOpened.tabs.mr").get(0).dispatchEvent(r),
                    n.addClass("active"),
                    (e = n.find("iframe")).length && e.attr("src", e.attr("src"));
            }),
    ...
    (mr = (function (t) {
        ...
        return (
            ...
            (t.toggleClass.documentReady = function (n) {
    ...
    (mr = (function (i) {
        ...
        return (
            (i.typed = i.typed || {}),
            (i.typed.documentReady = function (o) {
                o(".typed-text").each(function () {
                    var t = o(this),
                        e = (t.attr("data-typed-strings") && t.attr("data-typed-strings").split(","), { strings: [], typeSpeed: 100, loop: !0, showCursor: !1 }),
                        a = {};
                    (a.strings = t.attr("data-typed-strings") ? t.attr("data-typed-strings").split(",") : void 0), o(t).typed(jQuery.extend({}, e, i.typed.options, a));
                });
            }),
            i.components.documentReady.push(i.typed.documentReady),
            i
        );
    })(mr, jQuery, window, document)),
    (mr = (function (n) {
        ...
        return (
            (n.twitter = n.twitter || {}),
            (n.twitter.options = n.twitter.options || {}),
            (n.twitter.documentReady = function (a) {
                a(".tweets-feed")
                    .each(function (t) {
                    ...
                    .each(function (t) {
                        ...
                        (e = jQuery.extend(e, n.twitter.options)),
                            void 0 !== i.attr("data-widget-id")
                                ? (e.id = i.attr("data-widget-id"))
                                : void 0 !== i.attr("data-feed-name") && "" !== i.attr("data-feed-name")
                                ? (e.profile = { screenName: i.attr("data-feed-name").replace("@", "") })
                                : void 0 !== n.twitter.options.profile
                                ? (e.profile = { screenName: n.twitter.options.profile.replace("@", "") })
                                : (e.profile = { screenName: "twitter" }),
                            (e.maxTweets = i.attr("data-amount") ? i.attr("data-amount") : e.maxTweets),
                            i.closest(".twitter-feed--slider").length && i.addClass("slider"),
                            twitterFetcher.fetch(e);
                    });
            }),
            n.components.documentReady.push(n.twitter.documentReady),
            n
        );
    })(mr, jQuery, window, document)),
    (mr = (function (a) {
        ...
        return (
            ...
            (a.video.documentReady = function (o) {
                o(".youtube-background").length &&
                    o(".youtube-background").each(function () {
                        var t = o(this),
                            e = {};
                        (e.videoURL = o(this).attr("data-video-url")),
                            (e.startAt = o(this).attr("data-start-at") ? parseInt(o(this).attr("data-start-at"), 10) : void 0),
                            t.closest(".videobg").append('<div class="loading-indicator"></div>'),
                            t.YTPlayer(jQuery.extend({}, { containment: "self", autoPlay: !0, mute: !0, opacity: 1 }, a.video.options.ytplayer, e)),
                            t.on("YTPStart", function () {
                                t.closest(".videobg").addClass("video-active");
                            });
                    }),
                    o(".videobg").find("video").length && o(".videobg").find("video").closest(".videobg").addClass("video-active"),
                    o(".video-cover").each(function () {
                        var t = o(this);
    ...
    (mr = (function (a) {
        ...
        return (
            (a.wizard = a.wizard || {}),
            (a.wizard.documentReady = function (t) {
                t(".wizard").each(function () {
                    var t,
                        e = jQuery(this);
                    (t = { headerTag: "h5", bodyTag: "section", transitionEffect: "slideLeft", autoFocus: !0 }), e.is('[role="application"][id^="steps-uid"]') || (e.steps(jQuery.extend({}, t, a.wizard.options)), e.addClass("active"));
                });
            }),
